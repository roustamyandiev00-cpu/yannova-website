...
function Navbar() {
    ...
    if ($[0] !== "e7fab39c203be61a9976eafa2cdbbfd962dc333faebba2e2655031def6292d30") {
        for(let $i = 0; $i < 43; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "e7fab39c203be61a9976eafa2cdbbfd962dc333faebba2e2655031def6292d30";
    }
    ...
    const t6 = scrolled ? "bg-[#0a0c10]/95 backdrop-blur-sm py-3 shadow-lg" : "bg-gradient-to-b from-black/60 to-transparent backdrop-blur-[2px] py-5";
    let t7;
    if ($[8] !== t6) {
...
function CartProvider(t0) {
    ...
    if ($[0] !== "2ae45756b30b4db7ca1a8a359aa078b8b7a056b8f360ad7728379308541ebbbe") {
        for(let $i = 0; $i < 13; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "2ae45756b30b4db7ca1a8a359aa078b8b7a056b8f360ad7728379308541ebbbe";
    }
    const { children } = t0;
    let t1;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
                ...
                setItems({
                    "CartProvider[addItem > setItems()]": (prev)=>{
                        const existing = prev.find({
                            "CartProvider[addItem > setItems() > prev.find()]": (i)=>i.id === item.id
                        }["CartProvider[addItem > setItems() > prev.find()]"]);
                        if (existing) {
                            return prev.map({
                                "CartProvider[addItem > setItems() > prev.map()]": (i_0)=>i_0.id === item.id ? {
                                        ...i_0,
                                        quantity: i_0.quantity + item.quantity
                                    } : i_0
            ...
            "CartProvider[removeItem]": (id)=>{
                setItems({
                    "CartProvider[removeItem > setItems()]": (prev_0)=>prev_0.filter({
                            "CartProvider[removeItem > setItems() > prev_0.filter()]": (i_1)=>i_1.id !== id
    ...
    let t5;
    if ($[5] !== items) {
        t5 = items.reduce(_CartProviderItemsReduce, 0);
        $[5] = items;
        $[6] = t5;
    } else {
        t5 = $[6];
    ...
    if ($[10] !== children || $[11] !== t6) {
        t7 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CartContext.Provider, {
            value: t6,
            children: children
        }, void 0, false, {
...
_s(CartProvider, "Y4Dcq613gRbIq9tBN//onJfaA4E=");
_c = CartProvider;
function _CartProviderItemsReduce(sum, i_2) {
    return sum + i_2.quantity;
}
function useCart() {
    _s1();
...
//# sourceMappingURL=src_b6347a51._.js.map