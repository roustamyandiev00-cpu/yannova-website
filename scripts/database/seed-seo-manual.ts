...
const seoData = [
  {
    path: '/',
    title: 'Yannova Bouw | Ramen, Deuren & Renovatie Geraardsbergen - 30 Jaar Garantie',
    description: 'Uw betrouwbare aannemer voor ramen en deuren, gevelisolatie, crepi en totaalrenovatie in Geraardsbergen, Ninove en de Vlaamse Ardennen. ✓ 30 jaar garantie ✓ Gratis offerte',
    keywords: 'ramen deuren, renovatie geraardsbergen, gevelrenovatie, crepi, isolatie, totaalrenovatie vlaamse ardennen',
    h1: 'Uw Specialist voor Ramen, Deuren en Renovatie',
    ogTitle: 'Yannova Bouw - Renovatie in Geraardsbergen & Vlaamse Ardennen',
  ...
  },
  {
    ...
    description: 'Ontdek onze diensten: PVC en aluminium ramen en deuren, gevelrenovatie met crepi, isolatiewerken en totaalrenovatie in Geraardsbergen en Vlaamse Ardennen.',
  ...
  {
    path: '/projecten',
    title: 'Realisaties | Renovatie Projecten Geraardsbergen & Vlaamse Ardennen - Yannova',
    description: 'Bekijk onze afgeronde renovatieprojecten. Ramen, deuren, gevelrenovatie en totaalrenovaties in Geraardsbergen, Ninove, Ronse en omgeving.',
    ...
    ogDescription: 'Bekijk onze mooiste renovatieprojecten in de Vlaamse Ardennen. Inspiratie voor uw woning!',
  },
  {
    path: '/over-ons',
    title: 'Over Ons | Yannova Bouw - Renovatiebedrijf Geraardsbergen sinds 2010',
    description: 'Leer Yannova Bouw kennen. Uw lokale renovatiepartner in Geraardsbergen met meer dan 15 jaar ervaring in ramen, deuren en totaalrenovatie.',
    keywords: 'over yannova, renovatiebedrijf geraardsbergen, aannemer vlaamse ardennen, wie zijn wij, over ons',
    h1: 'Over Yannova Bouw',
    ogTitle: 'Over Ons | Renovatiebedrijf Yannova Geraardsbergen',
    ogDescription: '15+ jaar ervaring in renovatie. Uw vertrouwde partner in Geraardsbergen en Vlaamse Ardennen.',
  },
  {
    path: '/advies',
  ...
  },
  {
    ...
    description: 'Neem contact op met Yannova Bouw voor een gratis offerte. Renovatie in Geraardsbergen, Ninove en de Vlaamse Ardennen. Bellen, mailen of formulier.',
    keywords: 'contact yannova, offerte aanvragen, renovatie offerte, aannemer geraardsbergen, contactgegevens',
