...
export const metadata: Metadata = generateSEO({
  title: "Deuren Wilrijk | Voor- en achterdeuren in PVC en aluminium | Yannova",
  description: "Deuren in Wilrijk? Yannova is specialist in voor- en achterdeuren in pvc en aluminium. Gratis opmeting en offerte binnen 24 uur. 15+ jaar ervaring in Wilrijk en omgeving.",
  path: "/deuren/wilrijk",
  keywords: ["deuren wilrijk", "deuren plaatsen wilrijk", "deuren Wilrijk", "nieuwe deuren wilrijk", "deuren specialist wilrijk"],
});

const breadcrumbSchema = generateBreadcrumbSchema([
  { name: "Home", url: "/" },
  { name: "Deuren", url: "/deuren" },
  { name: "Wilrijk", url: "/deuren/wilrijk" },
]);
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6">
                Deuren in <span className="text-secondary">Wilrijk</span>
              </h1>
              <p className="text-xl text-gray-300 leading-relaxed">
                Specialist in voor- en achterdeuren in pvc en aluminium in Wilrijk. Gratis opmeting, duidelijke offerte binnen 24 uur 
        ...
        <section className="py-20 bg-white/5">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto prose prose-invert prose-lg">
              <h2 className="text-3xl font-bold text-white mb-6">
                Deuren Plaatsen in Wilrijk: Wat U Moet Weten
              </h2>
              <p className="text-gray-300 leading-relaxed mb-6">
                Als u op zoek bent naar deuren in Wilrijk, bent u bij Yannova aan het juiste adres. 
