...
export const metadata: Metadata = generateSEO({
  title: "Deuren Wijnegem | Buitendeuren & Binnendeuren | Yannova",
  description: "Deuren in Wijnegem? Wij plaatsen kwalitatieve en veilige voor- en achterdeuren in PVC en aluminium. Ontdek ons aanbod en vraag een offerte aan.",
  path: "/deuren/wijnegem",
  keywords: ["deuren wijnegem","deuren vervangen wijnegem","nieuwe deuren wijnegem","deuren plaatsen wijnegem","deuren specialist wijnegem","aannemer deuren wijnegem"],
});

const breadcrumbSchema = generateBreadcrumbSchema([
  { name: "Home", url: "https://www.yannova.be/" },
  { name: "Deuren", url: "https://www.yannova.be/deuren" },
  { name: "Deuren Wijnegem", url: `https://www.yannova.be/deuren/wijnegem` },
]);
...
export default function DeurenWijnegemPage() {
  return (
    <>
      <script
          ...
          <div className="container relative z-10 mx-auto px-6">
            <div className="max-w-4xl">
              <div className="flex items-center gap-2 text-secondary mb-4">
                ...
                <span className="text-sm font-medium uppercase tracking-wider">Wijnegem en Provincie Antwerpen</span>
              </div>
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-white mb-6 leading-tight">
                Deuren in <span className="text-secondary">Wijnegem</span> vervangen of plaatsen
              </h1>
              <p className="text-xl text-gray-300 leading-relaxed mb-8 max-w-2xl">
                Bent u op zoek naar nieuwe deuren in Wijnegem? Yannova levert en plaatst hoogwaardige voor- en achterdeuren in pvc en aluminium. 
          ...
          <div className="lg:col-span-2 space-y-16">
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-gray-900">
                Specialist in deuren in omgeving Wijnegem
              </h2>
              <p className="text-gray-700 leading-relaxed mb-6 text-lg">
                Het vervangen van uw deuren is een investering die zichzelf op termijn terugverdient. Zeker met de stijgende 
                energieprijzen is goede isolatie in uw woning in Wijnegem belangrijker dan ooit. Wij werken uitsluitend met 
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <p className="text-gray-600">
                    ...
                    zijn verkrijgbaar in talloze kleuren en afwerkingen in Wijnegem.
                  </p>
                </div>
                <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                  <h3 className="text-xl font-bold mb-3 text-secondary flex items-center gap-2">
            ...
            <section className="border-t border-gray-200 pt-12 mt-12">
              ...
              <div className="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <p className="text-gray-600 text-sm">
                    In veel profielen plaatsen wij probleemloos zwaar triple glas voor specifieke zware thermische of akoestische bouw-eisen in Wijnegem.
                  </p>
                </div>
                <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                  <h3 className="text-lg font-bold mb-2 text-secondary">Kleur op maat in Wijnegem</h3>
                  <p className="text-gray-600 text-sm">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start gap-4 bg-white p-4 rounded-lg shadow-sm">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm mt-1">Geen verassingen of verborgen kosten. Wij komen bij u in Wijnegem langs, meten correct op en leveren een duidelijke offerte.</p>
                  </div>
                </li>
                <li className="flex items-start gap-4 bg-white p-4 rounded-lg shadow-sm">
                  <ShieldCheck className="w-6 h-6 text-secondary flex-shrink-0 mt-1" />
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-gray-900">
                Premies voor nieuwe deuren in Wijnegem
              </h2>
              <p className="text-gray-700 leading-relaxed mb-6 text-lg">
                ...
                (deuren) van uw woning in Wijnegem.
              </p>
              ...
              <div className="bg-blue-50 border-l-4 border-secondary p-6 rounded-r-xl">
                ...
                <p className="text-gray-700 leading-relaxed text-sm">
                  ...
                  werf in Wijnegem direct alle nodige bijlages. Zowel voor hr-glas, geluidswerend glas als het 
            ...
            <section className="border-t border-gray-200 pt-12">
               ...
               <div className="flex flex-wrap gap-4">
                 ...
                 <a href="/diensten/gevelrenovatie" className="inline-block bg-white text-secondary font-semibold border border-gray-200 shadow-sm px-6 py-3 rounded-full hover:bg-secondary hover:text-white transition-colors">
                   Gevelisolatie en Crepi in Wijnegem
                 </a>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-28 bg-gray-900 rounded-2xl p-8 text-white shadow-xl">
              <h3 className="text-2xl font-bold mb-4">
                Wilt u de prijs voor uw woning in Wijnegem weten?
              </h3>
              ...
              <div className="mt-8 pt-8 border-t border-white/10">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-400">Actief in Wijnegem en omstreken.</div>
                  </div>
                </div>
              </div>
            </div>
