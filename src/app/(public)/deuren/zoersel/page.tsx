...
export const metadata: Metadata = generateSEO({
  title: "Deuren Zoersel | Buitendeuren & Binnendeuren | Yannova",
  description: "Deuren in Zoersel? Wij plaatsen kwalitatieve en veilige voor- en achterdeuren in PVC en aluminium. Ontdek ons aanbod en vraag een offerte aan.",
  path: "/deuren/zoersel",
  keywords: ["deuren zoersel","deuren vervangen zoersel","nieuwe deuren zoersel","deuren plaatsen zoersel","deuren specialist zoersel","aannemer deuren zoersel"],
});

const breadcrumbSchema = generateBreadcrumbSchema([
  { name: "Home", url: "https://www.yannova.be/" },
  { name: "Deuren", url: "https://www.yannova.be/deuren" },
  { name: "Deuren Zoersel", url: `https://www.yannova.be/deuren/zoersel` },
]);
          ...
          <div className="container relative z-10 mx-auto px-6">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-white mb-6 leading-tight">
                Deuren in <span className="text-secondary">Zoersel</span> vervangen of plaatsen
              </h1>
              <p className="text-xl text-gray-300 leading-relaxed mb-8 max-w-2xl">
                Bent u op zoek naar nieuwe deuren in Zoersel? Yannova levert en plaatst hoogwaardige voor- en achterdeuren in pvc en aluminium. 
          ...
          <div className="lg:col-span-2 space-y-16">
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-gray-900">
                Specialist in deuren in omgeving Zoersel
              </h2>
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-gray-900">
                Premies voor nieuwe deuren in Zoersel
              </h2>
              <p className="text-gray-700 leading-relaxed mb-6 text-lg">
                ...
                (deuren) van uw woning in Zoersel.
              </p>
