...
export const metadata: Metadata = generateSEO({
  title: "Deuren Brasschaat | Voor- en achterdeuren in PVC en aluminium | Yannova",
  description: "Deuren in Brasschaat? Yannova is specialist in voor- en achterdeuren in pvc en aluminium. Gratis opmeting en offerte binnen 24 uur. 15+ jaar ervaring in Brasschaat en omgeving.",
  path: "/deuren/brasschaat",
  keywords: ["deuren brasschaat", "deuren plaatsen brasschaat", "deuren Brasschaat", "nieuwe deuren brasschaat", "deuren specialist brasschaat"],
});

const breadcrumbSchema = generateBreadcrumbSchema([
  { name: "Home", url: "/" },
  { name: "Deuren", url: "/deuren" },
  { name: "Brasschaat", url: "/deuren/brasschaat" },
]);
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6">
                Deuren in <span className="text-secondary">Brasschaat</span>
              </h1>
              <p className="text-xl text-gray-300 leading-relaxed">
                Specialist in voor- en achterdeuren in pvc en aluminium in Brasschaat. Gratis opmeting, duidelijke offerte binnen 24 uur 
        ...
        <section className="py-20 bg-white/5">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto prose prose-invert prose-lg">
              <h2 className="text-3xl font-bold text-white mb-6">
                Deuren Plaatsen in Brasschaat: Wat U Moet Weten
              </h2>
              <p className="text-gray-300 leading-relaxed mb-6">
                Als u op zoek bent naar deuren in Brasschaat, bent u bij Yannova aan het juiste adres. 
