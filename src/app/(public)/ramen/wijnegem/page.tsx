...
export const metadata: Metadata = generateSEO({
  title: "Ramen Wijnegem | Ramen Vervangen & Plaatsen | Yannova",
  description: "Ramen in Wijnegem? Yannova is specialist in PVC en aluminium ramen met HR++ isolatieglas. Verlaag uw energiefactuur! Vraag nu een gratis offerte.",
  path: "/ramen/wijnegem",
  keywords: ["ramen wijnegem","ramen vervangen wijnegem","nieuwe ramen wijnegem","ramen plaatsen wijnegem","ramen specialist wijnegem","aannemer ramen wijnegem"],
});

const breadcrumbSchema = generateBreadcrumbSchema([
  { name: "Home", url: "https://www.yannova.be/" },
  { name: "Ramen", url: "https://www.yannova.be/ramen" },
  { name: "Ramen Wijnegem", url: `https://www.yannova.be/ramen/wijnegem` },
]);
...
export default function RamenWijnegemPage() {
  return (
    <>
      <script
          ...
          <div className="container relative z-10 mx-auto px-6">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-white mb-6 leading-tight">
                Ramen in <span className="text-secondary">Wijnegem</span> vervangen of plaatsen
              </h1>
              <p className="text-xl text-gray-300 leading-relaxed mb-8 max-w-2xl">
                Bent u op zoek naar nieuwe ramen in Wijnegem? Yannova levert en plaatst hoogwaardige pvc en aluminium ramen met hr++ glas. 
          ...
          <div className="lg:col-span-2 space-y-16">
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-gray-900">
                Specialist in ramen in omgeving Wijnegem
              </h2>
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-gray-900">
                Premies voor nieuwe ramen in Wijnegem
              </h2>
              <p className="text-gray-700 leading-relaxed mb-6 text-lg">
                ...
                (ramen) van uw woning in Wijnegem.
              </p>
