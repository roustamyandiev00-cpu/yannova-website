...
export const metadata: Metadata = generateSEO({
  title: "Ramen Wilrijk | Ramen Vervangen & Plaatsen | Yannova",
  description: "Ramen in Wilrijk? Yannova is specialist in PVC en aluminium ramen met HR++ isolatieglas. Verlaag uw energiefactuur! Vraag nu een gratis offerte.",
  path: "/ramen/wilrijk",
  keywords: ["ramen wilrijk","ramen vervangen wilrijk","nieuwe ramen wilrijk","ramen plaatsen wilrijk","ramen specialist wilrijk","aannemer ramen wilrijk"],
});

const breadcrumbSchema = generateBreadcrumbSchema([
  { name: "Home", url: "https://www.yannova.be/" },
  { name: "Ramen", url: "https://www.yannova.be/ramen" },
  { name: "Ramen Wilrijk", url: `https://www.yannova.be/ramen/wilrijk` },
]);
...
export default function RamenWilrijkPage() {
  return (
    <>
      <script
          ...
          <div className="container relative z-10 mx-auto px-6">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-white mb-6 leading-tight">
                Ramen in <span className="text-secondary">Wilrijk</span> vervangen of plaatsen
              </h1>
              <p className="text-xl text-gray-300 leading-relaxed mb-8 max-w-2xl">
                Bent u op zoek naar nieuwe ramen in Wilrijk? Yannova levert en plaatst hoogwaardige pvc en aluminium ramen met hr++ glas. 
          ...
          <div className="lg:col-span-2 space-y-16">
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-gray-900">
                Specialist in ramen in omgeving Wilrijk
              </h2>
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-gray-900">
                Premies voor nieuwe ramen in Wilrijk
              </h2>
              <p className="text-gray-700 leading-relaxed mb-6 text-lg">
                ...
                (ramen) van uw woning in Wilrijk.
              </p>
