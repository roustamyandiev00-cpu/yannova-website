...
export const metadata: Metadata = generateSEO({
  title: "Ramen Schoten | Ramen Vervangen & Plaatsen | Yannova",
  description: "Ramen in Schoten? Yannova is specialist in PVC en aluminium ramen met HR++ isolatieglas. Verlaag uw energiefactuur! Vraag nu een gratis offerte.",
  path: "/ramen/schoten",
  keywords: ["ramen schoten","ramen vervangen schoten","nieuwe ramen schoten","ramen plaatsen schoten","ramen specialist schoten","aannemer ramen schoten"],
});

const breadcrumbSchema = generateBreadcrumbSchema([
  { name: "Home", url: "https://www.yannova.be/" },
  { name: "Ramen", url: "https://www.yannova.be/ramen" },
  { name: "Ramen Schoten", url: `https://www.yannova.be/ramen/schoten` },
]);
          ...
          <div className="container relative z-10 mx-auto px-6">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-white mb-6 leading-tight">
                Ramen in <span className="text-secondary">Schoten</span> vervangen of plaatsen
              </h1>
              <p className="text-xl text-gray-300 leading-relaxed mb-8 max-w-2xl">
                Bent u op zoek naar nieuwe ramen in Schoten? Yannova levert en plaatst hoogwaardige pvc en aluminium ramen met hr++ glas. 
          ...
          <div className="lg:col-span-2 space-y-16">
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-gray-900">
                Specialist in ramen in omgeving Schoten
              </h2>
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-gray-900">
                Premies voor nieuwe ramen in Schoten
              </h2>
              <p className="text-gray-700 leading-relaxed mb-6 text-lg">
                ...
                (ramen) van uw woning in Schoten.
              </p>
