...
export const metadata: Metadata = generateSEO({
  title: "Totaalrenovatie Schoten: Kosten, soorten en diensten - Alles voor uw renovatie.",
  description: "Totaalrenovatie in Schoten? Yannova is dé specialist voor een zorgeloze verbouwing van A tot Z. Transparante kosten, 15+ jaar ervaring en 1 vast aanspreekpunt. Vraag een offerte!",
  path: "/totaalrenovatie/schoten",
  keywords: ["totaalrenovatie Schoten","renovatiewerken Schoten","aannemer Schoten","verbouwen Schoten","renovatiebedrijf Schoten"],
});
...
const breadcrumbSchema = generateBreadcrumbSchema([
  ...
  { name: "Totaalrenovatie Schoten", url: `https://www.yannova.be/totaalrenovatie/schoten` },
]);
...
export default function TotaalrenovatieSchotenPage() {
  return (
    <>
      <script
          ...
          <div className="container relative z-10 mx-auto px-6">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-white mb-6 leading-tight">
                Totaalrenovatie in <span className="text-secondary">Schoten</span>
              </h1>
              <p className="text-xl text-gray-300 leading-relaxed mb-8 max-w-2xl">
                Bent u op zoek naar een betrouwbare aannemer voor een totaalrenovatie in Schoten? 
