...
export const metadata: Metadata = generateSEO({
  title: "Renovatie Berchem | Totaalrenovatie & Gevelwerken | Yannova",
  description: "Renovatie in Berchem? Yannova is dé specialist voor een zorgeloze verbouwing van A tot Z. Transparante kosten, 15+ jaar ervaring en 1 vast aanspreekpunt. Vraag een offerte!",
  path: "/renovatie/berchem",
  keywords: ["renovatie Berchem","renovatiewerken Berchem","aannemer Berchem","verbouwen Berchem","renovatiebedrijf Berchem"],
});
...
const breadcrumbSchema = generateBreadcrumbSchema([
  ...
  { name: "Renovatie Berchem", url: `https://www.yannova.be/renovatie/berchem` },
]);
...
export default function RenovatieBerchemPage() {
  return (
    <>
      <script
          ...
          <div className="container relative z-10 mx-auto px-6">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-white mb-6 leading-tight">
                Renovatie in <span className="text-secondary">Berchem</span>
              </h1>
              <p className="text-xl text-gray-300 leading-relaxed mb-8 max-w-2xl">
                Bent u op zoek naar een betrouwbare aannemer voor een renovatie in Berchem? 
