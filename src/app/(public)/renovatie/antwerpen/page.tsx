...
export const metadata: Metadata = generateSEO({
  title: "Renovatie Antwerpen | Totaalrenovatie & Gevelwerken | Yannova",
  description: "Renovatie in Antwerpen? Yannova is dé specialist voor een zorgeloze verbouwing van A tot Z. Transparante kosten, 15+ jaar ervaring en 1 vast aanspreekpunt. Vraag een offerte!",
  path: "/renovatie/antwerpen",
  keywords: ["renovatie Antwerpen","renovatiewerken Antwerpen","aannemer Antwerpen","verbouwen Antwerpen","renovatiebedrijf Antwerpen"],
});
...
const breadcrumbSchema = generateBreadcrumbSchema([
  ...
  { name: "Renovatie Antwerpen", url: `https://www.yannova.be/renovatie/antwerpen` },
]);
...
export default function RenovatieAntwerpenPage() {
  return (
    <>
      <script
          ...
          <div className="container relative z-10 mx-auto px-6">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-white mb-6 leading-tight">
                Renovatie in <span className="text-secondary">Antwerpen</span>
              </h1>
              <p className="text-xl text-gray-300 leading-relaxed mb-8 max-w-2xl">
                Bent u op zoek naar een betrouwbare aannemer voor een renovatie in Antwerpen? 
