...
export const metadata: Metadata = generateSEO({
  title: "Ramen Mortsel | PVC en aluminium ramen met HR++ glas | Yannova",
  description: "Ramen in Mortsel? Yannova is specialist in pvc en aluminium ramen met hr++ glas. Gratis opmeting en offerte binnen 24 uur. 15+ jaar ervaring in Mortsel en omgeving.",
  path: "/ramen/mortsel",
  keywords: ["ramen mortsel", "ramen plaatsen mortsel", "ramen Mortsel", "nieuwe ramen mortsel", "ramen specialist mortsel"],
});

const breadcrumbSchema = generateBreadcrumbSchema([
  { name: "Home", url: "/" },
  { name: "Ramen", url: "/ramen" },
  { name: "Mortsel", url: "/ramen/mortsel" },
]);
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl">
              <div className="flex items-center gap-2 text-secondary mb-4">
                ...
                <span className="text-sm font-medium">Mortsel en omgeving</span>
              </div>
              <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6">
                Ramen in <span className="text-secondary">Mortsel</span>
              </h1>
              <p className="text-xl text-gray-300 leading-relaxed">
                Specialist in pvc en aluminium ramen met hr++ glas in Mortsel. Gratis opmeting, duidelijke offerte binnen 24 uur 
                en vakkundige plaatsing door ervaren vaklui. Actief in Mortsel en omgeving.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <div>
                ...
                <div className="space-y-4 mb-8">
                  {[
                    "Lokaal actief in Mortsel en omgeving",
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl p-8 sticky top-24">
                ...
                <p className="text-gray-300 mb-6">
                  Neem contact op voor een vrijblijvende offerte in Mortsel. 
        ...
        <section className="py-20 bg-white/5">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto prose prose-invert prose-lg">
              <h2 className="text-3xl font-bold text-white mb-6">
                Ramen Plaatsen in Mortsel: Wat U Moet Weten
              </h2>
              <p className="text-gray-300 leading-relaxed mb-6">
                Als u op zoek bent naar ramen in Mortsel, bent u bij Yannova aan het juiste adres. 
                Met meer dan 15 jaar ervaring in de regio Mortsel en omgeving, weten wij precies wat er 
              ...
              <h3 className="text-2xl font-bold text-white mt-8 mb-4">
                Onze Werkwijze in Mortsel
              </h3>
              <p className="text-gray-300 leading-relaxed mb-4">
                Bij Yannova werken we volgens een vaste werkwijze die zorgt voor een vlot verloop 
                van uw project in Mortsel:
              </p>
              <ol className="text-gray-300 space-y-3 mb-6">
                <li><strong>Gratis opmeting:</strong> We komen bij u langs in Mortsel voor een gratis en vrijblijvende opmeting.</li>
              ...
              <h3 className="text-2xl font-bold text-white mt-8 mb-4">
                Premies en Subsidies in Mortsel
              </h3>
              <p className="text-gray-300 leading-relaxed">
                ...
                maximaal kunt besparen op uw project in Mortsel. Afhankelijk van uw situatie kunt u tot 
        ...
        <section className="py-20">
          <div className="container mx-auto px-6">
            <h2 className="text-3xl font-bold text-white mb-8 text-center">
              Onze andere diensten in Mortsel
            </h2>
