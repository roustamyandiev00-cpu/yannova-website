...
export const metadata: Metadata = generateSEO({
  title: "Deuren plaatsen Zoersel | PVC & Aluminium Deuren | Yannova",
  description: "Deuren plaatsen in Zoersel. PVC en aluminium deuren, voordeur, achterdeur, schuifdeuren. Gratis opmeting, offerte binnen 24u. Lokaal bedrijf.",
  path: "/deuren/zoersel",
  keywords: [
    "deuren zoersel",
    "deuren plaatsen zoersel",
    "pvc deuren zoersel",
    "aluminium deuren zoersel",
    "voordeur zoersel",
    "schuifdeuren zoersel",
  ],
});
...
const zoerselFAQs = [
  {
    question: "Wat kost een nieuwe deur in Zoersel?",
    answer: "De prijs hangt af van het type deur, materiaal en afmetingen. Een standaard voordeur in PVC kost gemiddeld €1.500-€3.000 inclusief plaatsing. Wij komen graag langs in Zoersel voor een gratis opmeting en offerte.",
  },
  {
...
const breadcrumbSchema = generateBreadcrumbSchema([
  ...
  { name: "Zoersel", url: "/deuren/zoersel" },
]);

const faqSchema = generateFAQSchema(zoerselFAQs);

export default function DeurenZoerselPage() {
  return (
    <>
      ...
      <div className="min-h-screen bg-[#0a0c10]">
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-3xl">
              ...
              <h1 className="text-4xl sm:text-5xl font-bold text-white">
                Deuren plaatsen in <span className="text-secondary">Zoersel</span>
              </h1>
              <p className="mt-6 text-xl text-gray-300 leading-relaxed">
                Specialist in PVC en aluminium deuren voor Zoersel en omgeving. Voordeur, achterdeur, schuifdeuren. 
        ...
        <section className="py-16 border-t border-white/10">
          <div className="container mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-bold text-white">Deuren in Zoersel</h2>
                <p className="mt-4 text-gray-400 leading-relaxed">
                  Als lokaal bedrijf zijn we vertrouwd met de woningen in Zoersel en omgeving. 
                  Wij leveren veilige, energiezuinige deuren met persoonlijke service.
                </p>
        ...
        <section className="py-16 border-t border-white/10">
          <div className="container mx-auto px-6">
            <h2 className="text-3xl font-bold text-white text-center mb-12">Veelgestelde vragen over deuren in Zoersel</h2>
        ...
        <section className="py-16 border-t border-white/10">
          <div className="container mx-auto px-6 text-center">
            <h2 className="text-2xl font-bold text-white">Nieuwe deur in Zoersel?</h2>
