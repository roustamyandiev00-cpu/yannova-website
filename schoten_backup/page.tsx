...
export const metadata: Metadata = generateSEO({
  title: "Ramen Schoten | PVC en aluminium ramen met HR++ glas | Yannova",
  description: "Ramen in Schoten? Yannova is specialist in pvc en aluminium ramen met hr++ glas. Gratis opmeting en offerte binnen 24 uur. 15+ jaar ervaring in Schoten en omgeving.",
  path: "/ramen/schoten",
  keywords: ["ramen schoten", "ramen plaatsen schoten", "ramen Schoten", "nieuwe ramen schoten", "ramen specialist schoten"],
});

const breadcrumbSchema = generateBreadcrumbSchema([
  { name: "Home", url: "/" },
  { name: "Ramen", url: "/ramen" },
  { name: "Schoten", url: "/ramen/schoten" },
]);

export default function RamenSchotenPage() {
  return (
    <>
      <script
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6">
                Ramen in <span className="text-secondary">Schoten</span>
              </h1>
              <p className="text-xl text-gray-300 leading-relaxed">
                Specialist in pvc en aluminium ramen met hr++ glas in Schoten. Gratis opmeting, duidelijke offerte binnen 24 uur 
        ...
        <section className="py-20 bg-white/5">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto prose prose-invert prose-lg">
              <h2 className="text-3xl font-bold text-white mb-6">
                Ramen Plaatsen in Schoten: Wat U Moet Weten
              </h2>
              <p className="text-gray-300 leading-relaxed mb-6">
                Als u op zoek bent naar ramen in Schoten, bent u bij Yannova aan het juiste adres. 
